    ...
    <footer className="w-full bg-gradient-to-b from-black to-[#0b0b0b] text-white relative">
      ...
      <div className="w-full px-6 lg:px-20 pt-12 pb-10 text-xl text-gray-300 leading-relaxed">
        ...
        <p>
          ...
          IRAN, MYANMAR or any other country that may be subject to
        ...
        <p>
          ...
          Trading CFDs carries a high level of risk.
        </p>
            ...
            <ul className="space-y-3 text-xl">
              {[
                ...
                <li key={i}>
                  <Link
                    to={item.link}
                    className="flex items-center gap-2 hover:text-[#d2aa73] transition"
                  >
